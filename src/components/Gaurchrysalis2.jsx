...
/* ─────────────────────────────────────────────────────────
   ...
   ───────────────────────────────────────────────────────── */
const BASE = "https://gaurchrysalis.co/";
...
const IMG = {
  ...
  SITE_VISIT:  `${BASE}assets/images/contact/site_visit.webp`,
  GALLERY: [
    `${BASE}assets/images/gallery/Gallery%201.webp`,
    `${BASE}assets/images/gallery/Gallery%202.webp`,
    `${BASE}assets/images/gallery/Gallery%203.webp`,
    `${BASE}assets/images/gallery/Gallery%204.webp`,
    `${BASE}assets/images/gallery/Gallery%205.webp`,
  ],
  AMENITIES: [
    { src: `${BASE}assets/images/amenities/Basketball%20Court.webp`,    label: "Basketball Court"  },
    { src: `${BASE}assets/images/amenities/Swimming%20Pool.webp`,       label: "Swimming Pool"     },
    { src: `${BASE}assets/images/amenities/Indoor%20Games%20Zone.webp`, label: "Indoor Games Zone" },
    { src: `${BASE}assets/images/amenities/Yoga%20Deck.webp`,           label: "Yoga Deck"         },
    { src: `${BASE}assets/images/amenities/Multipurpose%20Court.webp`,  label: "Multipurpose Court"},
    { src: `${BASE}assets/images/amenities/Gymnasium.webp`,             label: "Gymnasium"         },
  ],
    ...
    <>
      ...
      <div className={`mob-menu ${menuOpen ? "open" : ""}`}>
        ...
        <a href="tel:+919716007900" style={{ color: "var(--gold)", marginTop: "0.5rem" }}>
          <i className="fa fa-phone" style={{ marginRight: 8 }} /> +91 72900 99009
        </a>
      </div>
                ...
                <div className="row g-4 align-items-center">
                  <div className="col-md-5">
                    <div className="overview-img" data-aos="fade-up">
                      <SImg src={IMG.ABOUT} alt="Gaur Chrysalis 2.0 Overview" height={300} />
                    </div>
                  </div>
        ...
        <section className="fp-section-gc section-pad" id="floorplan">
          <div className="container-lg">
            ...
            <div className="row g-4 justify-content-center" data-aos="fade-up">
              {[
                { img: IMG.MASTER_PLAN, label: "Tentative Master Plan Layout" },
                { img: IMG.UNIT_PLAN,   label: "Tentative Unit Plan Layout"   },
              ].map(({ img, label }) => (
            ...
            <div className="enq-card-gc" data-aos="fade-up">
              <div className="row g-0">
                ...
                <div className="col-lg-5" style={{ minHeight: 300, overflow: "hidden" }}>
                  <SImg src={IMG.SITE_VISIT} alt="Schedule Site Visit" height={420} style={{ height: "100%", objectFit: "cover", minHeight: 300 }} />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="row g-4" data-aos="fade-up">
              ...
              <div className="col-lg-4">
                <div className="about-card-gc" style={{ display: "flex", flexDirection: "column", justifyContent: "center", gap: "1rem", alignItems: "center", textAlign: "center" }}>
                  ...
                  <div style={{ font: "700 1.1rem var(--sans)", color: "#f3e3c8" }}>NINE WALL REALITY PVT LTD</div> */}
                  ...
                  <a href="tel:+919716007900" style={{ color: "var(--gold)", font: "700 1.05rem var(--sans)", display: "flex", alignItems: "center", gap: 8 }}>
                    <i className="fa fa-phone" /> +91 72900 99009
                  </a>
                </div>
              </div>
            </div>
